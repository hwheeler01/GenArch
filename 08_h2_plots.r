...
pdf(file="plots/GTEx_cross-tissue_global_v_local_h2_" %&% date %&% ".pdf",height=5,width=5)
...
pdf(file="plots/GTEx_cross-tissue_global_v_local_v_chr_h2_" %&% date %&% ".pdf",height=5,width=5)
...
for(tis in tissues[,1]){
  ...
  pdf(file="plots/GTEx_resid_" %&% tis %&% "_global_v_local_h2_" %&% date %&% ".pdf",height=5,width=5)
  ...
  pdf(file="plots/GTEx_resid_" %&% tis %&% "_global_v_local_v_chr_h2_" %&% date %&% ".pdf",height=5,width=5)
...
pdf(file="plots/hist_GTEx_localGRM_h2_" %&% date %&% ".pdf",height=6,width=10)
par(mfcol=c(2,4))
###no ylim
...
dev.off()
###ylim = 3000
pdf(file="plots/hist_GTEx_localGRM_h2_ylim3000_" %&% date %&% ".pdf",height=6,width=10)
par(mfcol=c(2,4))
...
pdf(file="plots/hist_GTEx_localGRM_p_" %&% date %&% ".pdf",height=6,width=10)
par(mfcol=c(2,4))
###no ylim
...
pdf(file="plots/hist_GTEx_localGRM_globalGRM_h2_" %&% date %&% ".pdf",height=10,width=10)
par(mfcol=c(4,4))
###ylim = 2000
...
pdf(file="plots/hist_GTEx_localGRM_globalGRM_se_" %&% date %&% ".pdf",height=10,width=10)
par(mfcol=c(4,4))
###ylim = 5000
...
pdf(file="plots/hist_GTEx_localGRM_chrGRM_globalGRM_h2_" %&% date %&% ".pdf",height=10,width=15)
par(mfcol=c(4,6))
###ylim = 2000
...
###plot histograms of se
pdf(file="plots/hist_GTEx_localGRM_chrGRM_globalGRM_se_" %&% date %&% ".pdf",height=10,width=15)
par(mfcol=c(4,6))
###ylim = 4000
...
###plot scatterplots global v. local h2 on one pdf
pdf(file="plots/scatter_GTEx_localGRM_globalGRM_h2_" %&% date %&% ".pdf",height=6,width=10)
par(mfcol=c(2,4))
###no ylim
plot(grms$local.h2,grms$global.h2,xlim=c(0,1),ylim=c(0,1),cex=0.5,xlab="localGRM h2",ylab="globalGRM h2",
...
###plot 3D scatterplots global v. local v. chr h2 on one pdf
pdf(file="plots/scatter_GTEx_localGRM_chrGRM_globalGRM_h2_" %&% date %&% ".pdf",height=6,width=10)
par(mfcol=c(2,4))
###no ylim
