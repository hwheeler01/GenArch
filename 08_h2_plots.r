...
date <- Sys.Date()
grms<-read.table('GTEx.cross-tissue.h2.all.models_2015-02-17.txt',header=T,sep="\t")
...
png(file="plots/hist_GTEx_localGRM_h2_" %&% date %&% ".png",height=6,width=10,units="in",res=100)
par(mfcol=c(2,4))
###no ylim
...
dev.off()
###ylim = 3000
png(file="plots/hist_GTEx_localGRM_h2_ylim3000_" %&% date %&% ".png",height=6,width=10,units="in",res=100)
par(mfcol=c(2,4))
...
png(file="plots/hist_GTEx_localGRM_p_" %&% date %&% ".png",height=6,width=10,units="in",res=100)
par(mfcol=c(2,4))
###no ylim
...
png(file="plots/hist_GTEx_localGRM_chrGRM_globalGRM_h2_" %&% date %&% ".png",height=10,width=15,units="in",res=100)
par(mfcol=c(4,6))
###ylim = 2000
...
###plot histograms of se
png(file="plots/hist_GTEx_localGRM_chrGRM_globalGRM_se_" %&% date %&% ".png",height=10,width=15,units="in",res=100)
par(mfcol=c(4,6))
###ylim = 4000
...
png(file="plots/scatter_GTEx_localGRM_globalGRM_h2_" %&% date %&% ".png",height=6,width=10,units="in",res=100)
par(mfcol=c(2,4))
###no ylim
plot(grms$local.h2,grms$global.h2,xlim=c(0,1),ylim=c(0,1),cex=0.5,xlab="localGRM h2",ylab="globalGRM h2",
...
png(file="plots/scatter_GTEx_localGRM_chrGRM_globalGRM_h2_" %&% date %&% ".png",height=6,width=10,units="in",res=100)
par(mfcol=c(2,4))
###no ylim
