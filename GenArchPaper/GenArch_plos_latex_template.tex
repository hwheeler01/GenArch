...
For the original whole tissue, we expected the whole tissue expression heritability to correlate with the posterior probability of a gene being actively regulated in a tissue as shown in Figure 6 A \hl{plot...}. The tissue specific phenotype heritability showed highest correlation with the PPA of the matching tissue, confirming that OTD also captures tissue-specific components of gene expression (Fig. \ref{fig-corrplot}). However, the 
