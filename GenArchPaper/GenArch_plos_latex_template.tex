...
like the University of Chicago. \cite{}

\hl{add to references} Grossman RL, Greenway M,
...
\url{doi:10.1109/SC.Companion.2012.127} 
...
\url{https://www.bionimbus-pdc.opensciencedatacloud.org/} \cite{}

\hl{add to references} Heath AP,Greenway M, Powell R, Spring J, Suarez R, Hanley D, Bandlamudi C,
McNerney ME, White KP and und RL, Bionimbus: A Cloud for Managing,
