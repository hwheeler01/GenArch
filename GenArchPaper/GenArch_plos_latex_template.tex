...
Our estimates of h2 for cross tissue expression traits are larger than the corresponding estimates for each whole tissue expression traits (\nameref{S5_Fig}). %For the remainder of this paper we will refer to the original tissue expression levels as whole tissue expression to distinguish from the tissue specific component, which does not have the cross tissue component.
