...
tissue & n & mean h$^2$ (SE) & \% $P<0.05$ & num $P<0.05$ & num expressed \\ 
  \hline
DGN Whole Blood & 922 & 0.143 (0.0015) & 49.2 & 6256 & 12719 \\ 
  Cross-tissue & 450 & 0.059 (0.0009) & 35.4 & 6003 & 16951 \\ 
...
As a measure of uncertainty, we have added two times the standard errors of each h\textsuperscript{2} estimate in gray segments. Genes with significant h\textsuperscript{2} ($P<0.05$) are shown in blue.  To be conservative, we set h$^2=0$ when GCTA did not converge.
}
\label{fig-dgn-jt-h2}
\end{figure}
