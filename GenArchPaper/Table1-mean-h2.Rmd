...
###Add FDR to table1
```{r}
FDR <- round(0.05*as.numeric(table1[,6])/as.numeric(table1[,5]),3)
newtable1 <- cbind(table1,FDR)
newtab <- xtable(newtable1)
print(newtab, type="latex",include.rownames=FALSE)
```
