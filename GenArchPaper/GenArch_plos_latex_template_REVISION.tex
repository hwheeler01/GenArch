...
In (\nameref{S5_Fig}) we show for one simulated example the correlation between true and OTD-estimated components for one gene, \textit{SLTM} (A) and the distribution of the correlation between true and OTD-estimates for all genes (B). The median Pearson correlation between true and OTD-estimted cross-tissue components was 0.54 [95\% CI: 0.33-0.77] and for tissue-specific components was 0.75 [0.46-0.88], demonstrating the robustness of our model (\nameref{S5_Fig}). 
