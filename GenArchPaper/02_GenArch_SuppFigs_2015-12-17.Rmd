...
```{r, glo.jt.tw,eval=TRUE,fig.width=12,fig.height=12}
...
```{r TWglmnet,eval=TRUE,fig.width=12,fig.height=12}
...
```{r TS_v_CT,fig.width=12,fig.height=12, echo=TRUE, warning=FALSE, message=FALSE,eval=TRUE}
...
```{r tscorr,warning=FALSE,message=FALSE,eval=TRUE,fig.width=12,fig.height=12}
...
```{r TW_v_CT,fig.width=12,fig.height=12, echo=TRUE, warning=FALSE, message=FALSE,eval=TRUE}
...
```{r twcorr,warning=FALSE,message=FALSE,eval=TRUE,fig.width=12,fig.height=12}
tislist <- scan('/Volumes/im-lab/nas40t2/hwheeler/cross-tissue/nine.tissue.list',sep="\n",what="character")
tw <- data.frame()
for(tis in tislist){
...
```{r CTTS,eval=TRUE,fig.width=12,fig.height=12}
