...
head(b)
dim(b)
getquant <- function(x) quantile(x,c(0.5,0.025,0.975))
apply(b,2,getquant)
...
#take second half of sampling iterations
b50 <- b[50001:100000,]
data<-gather(b50,component,proportion,-h,-rho,-pi,-n_gamma)
ggplot(data,aes(x=component,y=proportion)) + geom_boxplot()
apply(b50,2,getquant)

#take sampling iterations 5001:10000 (equivalent to 100K iterations)
b10 <- b[5001:10000,]
data<-gather(b10,component,proportion,-h,-rho,-pi,-n_gamma)
ggplot(data,aes(x=component,y=proportion)) + geom_boxplot()
apply(b10,2,getquant)
