...
Also, the correlation between tissue-specific OTD gene expression heritability and the posterior probability that the gene has an eQTL in that tissue is strongest in each respective tissue. 
