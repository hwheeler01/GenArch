...
Nicolae\textsuperscript{5}, Hae Kyung Im\textsuperscript{5}}
  ...
  \postdate{\par}
  \date{2015-08-20 14:56:17 \textsuperscript{1}Department of Biology and
...
Also, the correlation between tissue-specific OTD gene expression
heritability and the posterior probability that the gene has an eQTL in
that tissue is strongest in each respective tissue.
...
34. Bates D, Maechler M, Bolker BM, Walker S. Fitting linear
