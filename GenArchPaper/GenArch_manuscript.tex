...
Im\textsuperscript{1}}
  ...
  \postdate{\par}
  \date{2015-06-01 10:17:11 \textsuperscript{1}Department of Medicine,
...
We applied the elastic net {[}4{]} to model the effect of local genetic
...
\texttt{glmnet} {[}14,15{]} to perform 10-fold cross-validation of the
...
{[}14,15{]}. This tuning parameter \(\lambda\) controls the overall
...
\midrule
\endhead
(Intercept) & 0.13 & 0.1 & 1.27 & 0.21\tabularnewline
x & 2.03 & 0.1 & 19.64 & 0.00\tabularnewline
\bottomrule
\end{longtable}
...
14. Friedman J, Hastie T, Tibshirani R. Regularization paths for
generalized linear models via coordinate descent. Journal of Statistical
Software. 2010;33: 1--22. Available:
\url{http://www.jstatsoft.org/v33/i01/}

15. Simon N, Friedman J, Hastie T, Tibshirani R. Regularization paths
