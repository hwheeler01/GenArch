...
twh2 <- dplyr::rename(twh2,gene=AssociatedGeneName)
...
dim(a)
ggplot(a,aes(h2.WholeBlood,h2bloodcis)) + geom_point(alpha=1/4) + geom_smooth(method="lm") + theme_bw()
cor.test(a$h2.WholeBlood,a$h2bloodcis)
cor.test(a$h2.WholeBlood,a$h2blood)
cor.test(a$h2.WholeBlood,a$h2bloodtra)
