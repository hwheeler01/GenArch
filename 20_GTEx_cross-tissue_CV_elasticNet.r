...
################################################
rpkmid <- lmer.dir %&% "ranef.mean0.1.SUBJID"
expid <- scan(rpkmid,"character")
rpkmgene <- lmer.dir %&% "ranef.mean0.1.GENE"
geneid <- scan(rpkmgene,"character")
rpkmfile <- lmer.dir %&% "ranef.mean0.1.SUBJIDxGENE"
...
#gtfile <- gt.dir %&% 'GTEx_Analysis_2014-06-13.hapmapSnpsCEU.SNPxID.rds'
#gtX <- readRDS(gtfile)
